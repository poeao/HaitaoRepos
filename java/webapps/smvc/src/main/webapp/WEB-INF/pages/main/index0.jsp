...
<link href="${ctx}/js/dwz/themes/default/style.css" rel="stylesheet" type="text/css" media="screen"/>
<link href="${ctx}/js/dwz/themes/css/core.css" rel="stylesheet" type="text/css" media="screen"/>
<link href="${ctx}/js/dwz/themes/css/print.css" rel="stylesheet" type="text/css" media="print"/>
<!--[if IE]>
...
<script src="${ctx}/js/dwz/js/dwz.regional.zh.js" type="text/javascript"></script>
<script src="${ctx}/js/dwz/js/jquery.bgiframe.js" type="text/javascript"></script>

<script type="text/javascript">
$(function(){
	DWZ.init("${ctx}/js/dwz/dwz.frag.xml", {
...
//		loginUrl:"login.html",	// 跳到登录页面
		...
		callback:function(){
			initEnv();
			$("#themeList").theme({themeBase:"${ctx}/js/dwz/themes"}); // themeBase 相对于index页面的主题base路径
		}
	});
});
...
<body scroll="no">
		...
		<div id="header">
			<div class="headerNav">
				...
				<ul class="themeList" id="themeList">
					<li><a href="login.html" style="color:#FFFFFF;">修改密码</a></li>
					<li><a href="${ctx}/login" style="color:#FFFFFF;">退出</a></li>
	...
	<div id="footer">Copyright &copy; 2013 <a href="demo_page2.html" target="dialog">北京安宏睿业科技有限公司</a> Tel：010-62235911</div>
